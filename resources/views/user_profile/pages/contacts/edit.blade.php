...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('contact.save_settings', $contact->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-6 mt-5">
                     ...
                     <div class="col-md-6">
                    <div class="form-group">
                        <label for="phone_work">Password</label>
