            ...
            <form>
                ...
                <div class="row mb-3">
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="phone"
                            placeholder="Enter Name" wire:model="phone">
                        @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                            placeholder="Enter Name" wire:model="email">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('website') is-invalid @enderror" id="website"
                            placeholder="Enter Name" wire:model="website">
                        @error('website')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="facebook"
                            placeholder="Enter Facebook" wire:model="facebook">
                        @error('facebook')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="instagram"
                            placeholder="Enter Instagram" wire:model="instagram">
                        @error('instagram')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-lg-4 form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('twitter') is-invalid @enderror" id="linkedin"
                ...
                <div class=" gap-2">
                    <button wire:click.prevent="updatePost()" class="btn btn-success btn-block max-width-button">Update</button>
                    <button wire:click.prevent="cancelPost()" class="btn btn-secondary btn-block max-width-button">Cancel</button>
                </div>
            </form>
        </div>
    </div>
