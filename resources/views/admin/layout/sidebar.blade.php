<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['main-page/*']) }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#main-page" role="button" aria-expanded="{{ is_active_route(['advanced-ui/*']) }}" aria-controls="advanced-ui">
          <i class="link-icon" data-feather="anchor"></i>
          <span class="link-title">main pages</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['main-page/*']) }}" id="main-page">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/main-page/index') }}" class="nav-link {{ active_class(['main-page/index']) }}">Home</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/main-page/about') }}" class="nav-link {{ active_class(['main-page/about']) }}">About</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/main-page/service') }}" class="nav-link {{ active_class(['main-page/service']) }}">Service</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/main-page/blogs') }}" class="nav-link {{ active_class(['main-page/blogs']) }}">Blogs</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/main-page/contact') }}" class="nav-link {{ active_class(['main-page/contact']) }}">Contact</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item {{ active_class(['section/*']) }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#section" role="button" aria-expanded="{{ is_active_route(['section/*']) }}" aria-controls="section">
          <i class="link-icon" data-feather="anchor"></i>
          <span class="link-title">Add Section Details </span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['section/*']) }}" id="section">
          <ul class="nav sub-menu">
          <li class="nav-item">
              <a href="{{ url('header/create') }}" class="nav-link {{ active_class(['header/create']) }}">Header </a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/gallery') }}" class="nav-link {{ active_class(['section/gallery']) }}">Gallery</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('banner/create') }}" class="nav-link {{ active_class(['section/banner']) }}">Banners</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/section/about') }}" class="nav-link {{ active_class(['section/about']) }}">About</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/section/services') }}" class="nav-link {{ active_class(['section/services']) }}">Services</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/section/contact') }}" class="nav-link {{ active_class(['section/contact']) }}">Contact</a>
            </li>
          </ul>
        </div>
      </li>
